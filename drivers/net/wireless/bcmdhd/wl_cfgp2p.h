 ...
 *
 * $Id: wl_cfgp2p.h 447514 2014-01-09 10:19:46Z $
 */
...
#define P2P_MAX_PENDING_GAS			(16)
#define P2P_GAS_NOT_A_DIALOG_TOKEN	(0xFFFFFFFF)
...
struct p2p_info {
	...
	wlc_ssid_t ssid;
#ifdef WL11U
	/* Record the GAS dialog token of the P2P transaction. */
	uint32 gas_dialog_token[P2P_MAX_PENDING_GAS];
#endif /* WL11U */
};
